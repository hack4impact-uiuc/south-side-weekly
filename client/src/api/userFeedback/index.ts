...
import { UserFeedbackResponse, UsersFeedbackResponse } from './types';
...
const getUserFeedback = async (
  userId: string,
): Promise<Response<UsersFeedbackResponse>> => {
  const url = buildEndpoint(USER_FEEDBACK_ENDPOINT, 'user', userId);
